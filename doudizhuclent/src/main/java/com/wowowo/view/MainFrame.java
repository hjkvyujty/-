...
public class MainFrame extends JFrame {
	...
	public void init()
	{
		...
		chupaiJLabel.setIcon(new ImageIcon("F:\\xuexiJAVA\\doudizhu\\bg\\chupai.png"));
		...
		buchuJLabel.setIcon(new ImageIcon("F:\\xuexiJAVA\\doudizhu\\bg\\buchupai.png"));
	...
	public void getLord() {
		...
		lordLabel1.setIcon(new ImageIcon("F:\\xuexiJAVA\\doudizhu\\bg\\jiaodizhu.png"));
		...
		lordLabel2.setIcon(new ImageIcon("F:\\xuexiJAVA\\doudizhu\\bg\\bujiao.png"));
	...
	public void showChuPaiJabel()
	{
		...
		chuPaiThread=new ChuPaiThread(40, this);
		chuPaiThread.start();		
	...
	public void showMsg(int playerid, int typeid) {		
		...
		if(typeid==1)
		   msgLabel.setIcon(new ImageIcon("F:\\xuexiJAVA\\doudizhu\\bg\\buqiang.png"));
		if(typeid==3)		
		   msgLabel.setIcon(new ImageIcon("F:\\xuexiJAVA\\doudizhu\\bg\\buchu.png"));
	...
	public void showLordIcon(int playerid)
	{
		//创建地主图标对象
		 ...
		 lordIconLabel.setIcon(new ImageIcon("F:\\xuexiJAVA\\doudizhu\\bg\\dizhu.png"));
